...
namespace AwesomeDevEvents.Persistence.Migrations
{
    ...
    [Migration("20230802154714_FirstMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AwesomeDevEvents.Entities.DevEvent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("AwesomeDevEvents.Entities.DevEventSpeaker", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("AwesomeDevEvents.Entities.DevEventSpeaker", b =>
                {
                    b.HasOne("AwesomeDevEvents.Entities.DevEvent", null)
                        .WithMany("Speakers")
